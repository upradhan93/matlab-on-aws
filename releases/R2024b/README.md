...
| **Attach Public IP** | Choose if a public IP address should be attached to the MATLAB EC2 instance. If you choose to not enable Public IP, refer to the [Private networking configuration](#private-networking-configuration) section in the readme for more information. |
